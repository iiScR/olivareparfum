...
INSERT INTO reviews (id, product_id, name, city, rating, comment) VALUES
  (uuid_generate_v4(), 'a1111111-1111-1111-1111-111111111111', 'Amina B.', 'Casablanca', 5, 'Je suis bluffée par la similarité avec l''original. Santal Noir est exactement comme celui de Tom Ford à 5x le prix. Livraison rapide et emballage luxueux.'),
  ...
  (uuid_generate_v4(), 'a2222222-2222-2222-2222-222222222222', 'Laila M.', 'Marrakech', 5, 'La tenue est impressionnante — 10 heures facilement sur mes vêtements. Rose Velours est devenu mon signature scent. Merci Olivare !'),
  ...
  (uuid_generate_v4(), 'a3333333-3333-3333-3333-333333333333', 'Omar H.', 'Fès', 4, 'Très bon rapport qualité-prix. Oud Impérial est puissant et sophistiqué. J''apprécie particulièrement la transparence sur les notes olfactives.');
