...
INSERT INTO reviews (id, product_id, name, city, rating, comment) VALUES
  ...
  (uuid_generate_v4(), 'a2222222-2222-2222-2222-222222222222', 'Laila M.', 'Marrakech', 5, 'La tenue est impressionnante — 10 heures facilement sur mes vêtements. Agrumes Luxe est devenu mon signature scent. Merci IZIL PARFUMS !'),
  ...
  (uuid_generate_v4(), NULL, 'Samira K.', 'Agadir', 5, 'J''offre régulièrement IZIL PARFUMS à mes amies. C''est le cadeau parfait : luxueux, abordable, et tout le monde adore. L''emballage est sublime.'),
